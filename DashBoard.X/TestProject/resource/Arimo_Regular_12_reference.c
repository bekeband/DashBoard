 ...
 *****************************************************************************/
#if (GFX_EXTERNAL_FONT_RASTER_BUFFER_SIZE < 30)
...
#error Please define "#define GFX_EXTERNAL_FONT_RASTER_BUFFER_SIZE (30)" in GraphicsConfig.h.
#endif
