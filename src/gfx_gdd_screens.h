...
#define GFX_INDEX_0 RED
#define GFX_INDEX_1 BLUE
...
bool GDD_GOL_MessageCallback(GFX_GOL_TRANSLATED_ACTION objMsg, GFX_GOL_OBJ_HEADER *pObj, GFX_GOL_MESSAGE *pMsg);
