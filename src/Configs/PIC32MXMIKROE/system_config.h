...
/* note: For SSD1289
        ...
        Horizontal Cycle (280) = tHBP + DISP_HOR_FRONT_PORCH +
        DISP_HOR_RESOLUTION
        Vertical Cycle (326)   = tVBP + DISP_VER_FRONT_PORCH +
        DISP_VER_RESOLUTION

        In summary, the DISP_HOR_PULSE_WIDTH should not exceed tHBP and
        the DISP_VER_PULSE_WIDTH should not exceed tVBP. See SSD1289 data sheet
        for details.
*/
...
// -----------------------------------
#define APP_DEMO_FONT Gentium_16
#define OPTIONS_FONT Gentium8
//#define OPTIONS_FONT Arimo_Regular_12
...
/*********************************************************************
* IOS FOR THE SWITCH(bootloader button)
*********************************************************************/
#define BootButtonConfig()  TRISBbits.TRISB1
#define BootButtonsTest()   PORTBbits.RB1

/*********************************************************************
* IOS FOR THE LED's
*********************************************************************/

#define LEDPortsConfig()      (TRISD  &= 0b1111111111110000)  // set RD 0-3 output
#define LEDPortsClear()       (LATD   &= 0b1111111111110000)  //
#define LED_RED_01_LAT()      LATDbits.LATD0
#define LED_RED_01_PORT()     PORTDbits.RD0
#define LED_YELLOW_01_LAT()   LATDbits.LATD1
#define LED_YELLOW_01_PORT()  PORTDbits.RD1
#define LED_RED_02_LAT()      LATDbits.LATD2
#define LED_RED_02_PORT()     PORTDbits.RD2
#define LED_YELLOW_02_LAT()   LATDbits.LATD3
#define LED_YELLOW_02_PORT()  PORTDbits.RD3
...
#define TXLAT   LATFbits.LATF8
#define TXTRIS  TRISFbits.TRISF8

#define RXTRIS  TRISFbits.TRISF2
